...
namespace Stact.Workflow
{
	...
	public static class StateEventConfiguratorExtensions
	{
		public static StateEventConfigurator<TWorkflow, TInstance> TransitionTo<TWorkflow, TInstance>(
			this StateEventConfigurator<TWorkflow, TInstance> configurator, Expression<Func<TWorkflow, State>> targetStateExpression)
