...
namespace Stact.Workflow.Configuration
{
	...
	public class MethodStateEventConfigurator<TWorkflow, TInstance> :
		StateEventBuilderConfigurator<TWorkflow, TInstance>
		where TWorkflow : class
		where TInstance : class
	{
		readonly Expression<Func<TInstance, Action>> _methodExpression;

		public MethodStateEventConfigurator(Expression<Func<TInstance, Action>> methodExpression)
		{
		...
		{
			var stateEvent = new MethodStateEvent<TInstance>(builder.State, builder.Event, _methodExpression);
	...
	public class MethodStateEventConfigurator<TWorkflow, TInstance, TBody> :
		...
		where TInstance : class
	{
		...
		public MethodStateEventConfigurator(Expression<Func<TInstance, Action<TBody>>> methodExpression)
		{
			_methodExpression = methodExpression;
		}
		...
		{
			var stateEvent = new MethodStateEvent<TInstance, TBody>(builder.State, builder.Event, _methodExpression);
