...
namespace Stact.Configuration.Builders
{
	...
	public class UntypedChannelConnectionBuilder :
		ConnectionBuilder
	{
		readonly UntypedChannel _channel;
		readonly UntypedChannelConnection _connection;

		public UntypedChannelConnectionBuilder(UntypedChannel channel)
		{
		...
		public void AddChannel(UntypedChannel channel)
		{
