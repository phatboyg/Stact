        ...
        IDisposable
    {
                                              ...
                                              TimeSpan checkInterval)
        {
            ...
            _connection = myChannel.Connect(connectionConfigurator =>
                {
                    connectionConfigurator.Consume<FileSystemChanged>().UsingConsumer(HandleFileSystemChangedAndCreated);
                    connectionConfigurator.Consume<FileSystemCreated>().UsingConsumer(HandleFileSystemChangedAndCreated);
                    connectionConfigurator.Consume<FileSystemRenamed>().UsingConsumer(HandleFileSystemRenamed);
                    connectionConfigurator.Consume<FileSystemDeleted>().UsingConsumer(HandleFileSystemDeleted);
                });
