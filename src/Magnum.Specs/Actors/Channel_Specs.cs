...
namespace Magnum.Specs.Actors
{
	...
	public class Publishing_a_message_on_a_channel
	{
		...
		public void Should_filter_out_unwanted_messages()
		{
			...
			Channel<UserUpdate> channel = new ChannelRouter<UserUpdate>(new[] {filter});
		...
		public void Should_return_false_if_there_are_no_subscribers()
		{
			...
			Channel<UserUpdate> channel = new ChannelRouter<UserUpdate>(new Channel<UserUpdate>[] {});
		...
		public void Should_schedule_events()
		{
			...
			Channel<UserUpdate> channel = new ChannelRouter<UserUpdate>(new Channel<UserUpdate>[] {future});
