...
namespace Stact.Specs.Actors
{
    ...
    class Cleaner_version_of_defining_actor_behavior
    {
        public void Some_method_in_your_code()
        {
            ...
            ActorRef agent = Actor.New<AgentState>(x => x.ChangeBehavior<DefaultAgentBehavior>());
            ...
            Behavior<AgentState>
        {
            ...
            public void Handle(Message<RequestStockQuote> message)
            {
                ...
                var requestActor = Actor.New<RequestState>(x => x.ChangeBehavior<InitialRequestBehavior>());
            ...
            {
                _actor.ChangeBehavior<CacheAgentBehavior>();
            }
        }
            ...
            Behavior<AgentState>
        {
            ...
            {
                _actor.ChangeBehavior<DefaultAgentBehavior>();
            }
        }
