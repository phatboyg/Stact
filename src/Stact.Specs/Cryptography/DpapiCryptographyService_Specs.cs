...
namespace Stact.Specs.Cryptography
{
    using System.Collections.Generic;
    using System.IO;
    using System.Text;
    using Stact.Cryptography;
    using NUnit.Framework;

    [TestFixture]
    public class DpapiCryptographyService_Specs
    {
        ...
        public void Smoke()
        {
            ...
            using (ICryptographyService srv = new DpapiCryptographyService())
            {
            ...
            using (ICryptographyService srv2 = new DpapiCryptographyService())
            {
